...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>UEL Canteen</em></strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navi">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="order_food.php" >Order</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#orderFeast" >Order Feast</a>
                    </li>';   
                        }
                    ...
                    echo'
                    <li class="nav-item">
                        <a class="nav-link" href="view_accounts.php" >View Users</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="menu_management.php" >Update Menu</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="sample_trans.php" >Transactions</a>
                    </li>
	            ...
	            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#allergy">Allergy</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="download_menu.php">Menu</a>
                    </li>
                    <li class="nav-item">
