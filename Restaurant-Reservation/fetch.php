...
$columns = array('food_name', 'allergy');
...
{
 $query .= '
 WHERE food_name LIKE "%'.$_POST["search"]["value"].'%" 
 OR allergy LIKE "%'.$_POST["search"]["value"].'%" 
 ';
}
...
while($row = mysqli_fetch_array($result))
{
 $sub_array = array();
  ...
  $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="allergy">' . $row["allergy"] . '</div>';
